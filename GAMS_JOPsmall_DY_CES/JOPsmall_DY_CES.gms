...
*tmp1(F,I) = R0(F,I) * RA0(F)*(1 + SUM(GF,TAUFX(GF,F,I)))* (FD0(F,I))**(1-RHO(I));
tmp1(F,I) =  (1 + SUM(GF,TAUFX(GF,F,I)));
*===============================================================================
...
SPI0, R0, RA0, TP, A, AD, RHO, tmp1, TAUF
;
...
NEQ(K,I).. N(K,I)        =E= N0(K,I)*(R(K,I)/R0(K,I))**(ETAIX(K,I)*15);
