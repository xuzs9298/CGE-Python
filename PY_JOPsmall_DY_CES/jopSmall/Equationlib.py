  ...
  def write(self, filename):
    ...
    with open(filename, 'a') as f:
        for i in range(self.nvars):
            ...
            if self.initialVals[i] < lower or self.initialVals[i] > upper:
                print(self.initialVals[i], lower, upper)
            '''
            ...
            f.write('model.x' + str(i) + ' = Var(bounds=(' + str(lower-1e-5) + ',' + str(upper+1e-5) + '),initialize=' + str(value) + ')' + '\n')
